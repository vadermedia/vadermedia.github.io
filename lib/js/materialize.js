...
(function (factory) {
  ...
  function matches(el, selector) {
    var m = el &&
      (el.matches || el.webkitMatchesSelector || el.mozMatchesSelector ||
...
var docHandleKeydown = function (e) {
  M.keyDown = true;
  if (
    e.which === M.keys.TAB || e.which === M.keys.ARROW_DOWN ||
  ...
  var Collapsible = function (_Component) {
    ...
    _createClass(Collapsible, [{
      ...
      value: function _setupEventHandlers() {
        ...
        this._handleCollapsibleKeydownBound = this._handleCollapsibleKeydown
          .bind(this);
...
(function ($, anim) {
  ...
  var Dropdown = function (_Component2) {
    ...
    function Dropdown(el, options) {
      ...
      _this9._handleDocumentTouchmoveBound = _this9._handleDocumentTouchmove
        .bind(_this9);
    ...
    _createClass(Dropdown, [{
      ...
      value: function _handleMouseLeave(e) {
        ...
        if (
          $closestTrigger.length && !!$closestTrigger[0].M_Dropdown &&
      ...
      value: function _handleDocumentClick(e) {
        ...
        if (
          ...
          $target.closest(".dropdown-content").length && !this.isTouchMoving
        ) {
      ...
      value: function _getDropdownPosition() {
        ...
        if (!alignments[horizontalAlignment]) {
          var oppositeAlignment = horizontalAlignment === "left"
            ? "right"
            : "left";
  ...
  var Parallax = function (_Component5) {
    ...
    _createClass(Parallax, [{
      ...
      value: function _updateParallax() {
        ...
        var percentScrolled = (windowBottom - top) /
    ...
    _createClass(Tabs, [{
      ...
      value: function _setupActiveTabLink() {
        ...
        if (this.$activeTabLink.length === 0) {
          this.$activeTabLink = this.$el.children("li.tab").children("a.active")
            .first();
        }
        if (this.$activeTabLink.length === 0) {
      ...
      value: function _calcRightPos(el) {
        return Math.ceil(
          this.tabsWidth - el.position().left -
  ...
  var Sidenav = function (_Component8) {
    ...
    _createClass(Sidenav, [{
      ...
      value: function _handleDragTargetDrag(e) {
        ...
        this.el.style.transform = transformPrefix + " translateX(" +
          transformX + "px)";
      ...
      value: function _findElements(top, right, bottom, left) {
        ...
        for (var i = 0; i < ScrollSpy._elements.length; i++) {
          ...
          if (scrollspy.$el.height() > 0) {
            ...
            var isIntersect =
              !(elLeft > right || elRight < left || elTop > bottom ||
                elBottom < currTop);
  ...
  var Autocomplete = function (_Component10) {
    ...
    _createClass(Autocomplete, [{
      ...
      value: function _setupEventHandlers() {
        ...
        this._handleInputKeyupAndFocusBound = this._handleInputKeyupAndFocus
          .bind(this);
      ...
      value: function _handleInputKeydown(e) {
        ...
        if (keyCode === M.keys.ARROW_UP || keyCode === M.keys.ARROW_DOWN) {
          ...
          if (
            keyCode === M.keys.ARROW_DOWN && this.activeIndex < numItems - 1
          ) {
            this.activeIndex++;
          }
      ...
      value: function _highlight(string, $el) {
        ...
        $el.html(
          "<span>" + beforeMatch + "<span class='highlight'>" + matchText +
      ...
      value: function _renderDropdown(data, val) {
        ...
        for (var key in data) {
          if (
            data.hasOwnProperty(key) && key.toLowerCase().indexOf(val) !== -1
          ) {
            // Break if past limit
...
(function ($) {
  ...
  M.updateTextFields = function () {
    ...
    $(input_selector).each(function (element, index) {
      var $this = $(this);
      if (
        element.value.length > 0 || $(element).is(":focus") ||
  ...
  M.validate_field = function (object) {
    ...
    if (
      len === 0 && object[0].validity.badInput === false &&
      !object.is(":required")
    ) {
  ...
  var Chips = function (_Component12) {
    ...
    _createClass(Chips, [{
      ...
      value: function addChip(chip) {
        if (
          !this._isValid(chip) || this.chipsData.length >= this.options.limit
        ) {
          return;
        }
  ...
  var Pushpin = function (_Component13) {
    ...
    _createClass(Pushpin, [{
      ...
      value: function _updatePosition() {
        ...
        if (
          this.options.top <= scrolled && this.options.bottom >= scrolled &&
        ...
        if (
          scrolled < this.options.top && !this.el.classList.contains("pin-top")
        ) {
          this._removePinClasses();
          this.el.style.top = 0;
    ...
    function FloatingActionButton(el, options) {
      ...
      var _this48 = _possibleConstructorReturn(
        ...
        (FloatingActionButton.__proto__ ||
          Object.getPrototypeOf(FloatingActionButton)).call(
            this,
      ...
      value: function _animateInToolbar() {
        ...
        setTimeout(function () {
          ...
          setTimeout(function () {
            ...
            // Scroll to close.
            _this51._handleDocumentClickBound = _this51._handleDocumentClick
              .bind(_this51);
...
(function ($) {
  ...
  var Datepicker = function (_Component15) {
    ...
    function Datepicker(el, options) {
      ...
      if (
        !!options && options.hasOwnProperty("i18n") &&
      ...
      value: function render(year, month, randId) {
        ...
        for (var i = 0, r = 0; i < cells; i++) {
          var day = new Date(year, month, 1 + (i - before)),
            ...
            isEndRange = opts.endRange &&
              Datepicker._compareDates(opts.endRange, day),
            isInRange = opts.startRange && opts.endRange &&
              opts.startRange < day && day < opts.endRange,
  ...
  var Timepicker = function (_Component16) {
    ...
    _createClass(Timepicker, [{
      ...
      value: function _pickerSetup() {
        ...
        ).appendTo(confirmationBtnsContainer).on(
          "click",
...
(function ($) {
  ...
  var Carousel = function (_Component18) {
    ...
    function Carousel(el, options) {
      ...
      _this62.images = [];
      _this62.itemWidth = _this62.$el.find(".carousel-item").first()
        .innerWidth();
      _this62.itemHeight = _this62.$el.find(".carousel-item").first()
        .innerHeight();
  ...
  var TapTarget = function (_Component19) {
    ...
    _createClass(TapTarget, [{
      ...
      value: function _calculatePositioning() {
        ...
        var isCenterX = originLeft >= windowWidth * 0.25 &&
        ...
        var tapTargetTextLeft = isLeft && !isCenterX
          ? tapTargetWidth / 2 - originWidth
          : 0;
        ...
        // Calculating wave
        var tapTargetWaveWidth = originWidth > originHeight
          ? originWidth * 2
          : originWidth * 2;
  ...
  var FormSelect = function (_Component20) {
    ...
    _createClass(FormSelect, [{
      ...
      value: function _handleOptionClick(e) {
        ...
        var key = option.id;
        if (
          !$(option).hasClass("disabled") && !$(option).hasClass("optgroup") &&
          key.length
        ) {
          var selected = true;
          ...
          if (this.isMultiple) {
            ...
            if (placeholderOption.length) {
              ...
              placeholderOption.find('input[type="checkbox"]').prop(
                "checked",
                false,
              );
      ...
      value: function _setupDropdown() {
        ...
        if (!this.el.disabled) {
          ...
          dropdownOptions.onOpenEnd = function (el) {
            var selectedOption = $(_this71.dropdownOptions).find(".selected")
              .first();
      ...
      value: function _setSelectedStates() {
        ...
        for (var key in this._valueDict) {
          ...
          $(option.optionEl).find('input[type="checkbox"]').prop(
            "checked",
            optionIsSelected,
          );
          if (optionIsSelected) {
  ...
  var Range = function (_Component21) {
    ...
    _createClass(Range, [{
      ...
      value: function _setupEventHandlers() {
        ...
        this._handleRangeMouseupTouchendBound = this._handleRangeMouseupTouchend
          .bind(this);
