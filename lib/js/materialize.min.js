...
window.cash = function () {
  ...
  function k(t, e) {
    for (
      var i = t.length, n = 0; n < i && !1 !== e.call(t[n], t[n], n, t); n++
    );
  }
  function b(t, e) {
    var i = t &&
  ...
  Object.defineProperty(y, "constructor", { value: _ }),
    ...
    _.extend = y.extend = function (t) {
      ...
      for (1 === e.length && (t = this, n = 0); n < i; n++) {if (e[n]) {
          for (var s in e[n]) {
  ...
  y.extend({
    ...
    y.extend({
      ...
      get: function (t) {
        return void 0 === t ? r.call(this) : t < 0
          ? this[t + this.length]
          : this[t];
      },
      index: function (t) {
  ...
  return y.extend({
    ...
    y.extend({
      ...
      closest: function (t) {
        return !t || this.length < 1 ? _() : this.is(t)
          ? this.filter(t)
      ...
      parents: function (e) {
        ...
        return this.each(function (t) {
          for (
            i = t; i && i.parentNode && i !== o.body.parentNode;
          ) {
...
document.addEventListener("keydown", docHandleKeydown, !0),
  ...
  M.checkPossibleAlignments = function (t, e, i, n) {
    ...
    return s.spaceOnRight = o
      ...
      s.spaceOnBottom = o ? window.innerHeight - (h.top + i.height + n)
      : r - (p + i.height + n),
  ...
  return O.version = "2.2.0",
    ...
    O.remove = function (t) {
      ...
      for (var e = A.length; e--;) {
        for (
          var i = A[e], n = i.animations, s = n.length; s--;
        ) {
          ...
          _createClass(n, [{
            ...
            value: function (t) {
              if (t.which === M.keys.TAB) t.preventDefault(), this.close();
                ...
                if (t.which === M.keys.ENTER && this.isOpen) {
                  ...
                  t.which === M.keys.ESC && this.isOpen &&
            ...
            value: function () {
              ...
              if (
                ...
                l[u] ? d = u : l.spaceOnLeft > l.spaceOnRight
    ...
    var t = function (t) {
      function n(t, e) {
        ...
        return (i.el.M_FloatingActionButton = i).options = r.extend(
          ...
          : "bottom" === i.options.direction ? i.offsetY = -40 : i.offsetX = 40,
          i._setupEventHandlers(),
          i;
      }
      return _inherits(n, Component),
        ...
        return _inherits(B, Component),
          _createClass(B, [{
            ...
            value: function (t, e, i, n, s, o) {
              ...
              return (v += '<button class="month-next' + (m
                ? ""
                : " is-disabled") +
            ...
            value: function (t) {
              var e = void 0;
              t.firedBy !== this && (e = this.options.parse
      ...
      t = function (t) {
        ...
        return _inherits(i, Component),
          _createClass(i, [{
            ...
            key: "_wrap",
            value: function (t) {
              return t >= this.count ? t % this.count : t < 0
